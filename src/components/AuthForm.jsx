    ...
    <form className="font-body">
      {isRessettingPassword ? (
        <>
          <div className="flex flex-col mb-5">
            <label
              ...
              className="text-lg text-red-interactive"
            >
              Email
            </label>
            <input
          ...
          <button
            type="submit"
            onClick={toggleIsRessettingPassword}
            className="text-red-interactive text-base mt-5"
          >
            Back to sign in
          </button>
        </>
        ...
        <>
          ...
          <div className="flex flex-col mb-5">
            <label htmlFor="password" className="text-lg text-red-interactive">
              Password
            </label>
            <input
              type="password"
          ...
          <button
            ...
            className="text-red-interactive text-lg mt-5"
          >
            Sign in with Google
          </button>
          ...
          <button
            type="submit"
            onClick={toggleIsRessettingPassword}
            className="block text-red-interactive text-base mt-5"
          >
            Forgot Password?
          </button>
        </>
